				...
				<table width=700 height="460" border="0" align="center">
					<tr valign="middle">
						<td height="50" width="700" align="right" valign="middle"
							...
							href="javascript:searchPrice('<%=category%>','1~3')"> [3만원
								...
								[3~5만원] </a> <a href="javascript:searchPrice('<%=category%>','5~7')">
								[5~7만원] </a> <a
							href="javascript:searchPrice('<%=category%>','7~10')">
								[7~10만원] </a> <a href="javascript:searchPrice('<%=category%>','10')">
								[10만원 이상] </a> <a
							href="javascript:searchPrice('<%=category%>','all')"> [전체 보기]
						</a>
						</td>
					</tr>
					...
					<tr>
								...
								<tr>
									<c:choose>
										<c:when test="${requestScope.itemList[0].GOODS_NUM==null}">
											<tr>
												<td width="700" height="300" align="center">등록된 글이
													없습니다.</td>
											</tr>
										</c:when>
											...
											<c:forEach var="item" items="${requestScope.itemList}">
												<td width="180" valign="top"><br>
													<div align="center">
														...
														%>
														<a
															href="Goods_Detail.go?item=${item.GOODS_CATEGORY}
						...
						&isitem=other&price=${price}">
																				<%
																				/*<a
					href="javascript:viewLarge('/JS_ImageBoard/image/${theme.image}')"> <img
						src="/JS_ImageBoard/image/${theme.image}" width="150" border="0">
						<br>[크게보기]*/
																					}
																								}
