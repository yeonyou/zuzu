...
<body>
		...
		<tr>
			<td colspan=2 align=center>
				<table border=0 cellspacing=1 cellpadding=0 width=80%>
					<tr>
						<td align=right colspan=10 height=25 colspan=2 style="font-family: Tahoma; font-size: 8pt;">전체 주문 수 : <b><%=ordercount%></b> 개&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					...
					<tr align=center height=20>
						...
						<td style="font-family: Tahoma; font-size: 8pt;"><a href="./AdminOrderDetail.ao?num=<%=order.getORDER_NUM()%>"> Modify</a>/ <a href="./AdminOrderDelete.ao?num=<%=order.getORDER_NUM()%>" onclick="return confirm('삭제하시겠습니까?')">Delete</a></td>
					</tr>
					<tr>
						<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
					</tr>
 ...
 %> <a href="./AdminOrderList.ao?page=<%=nowpage - 1%>"> [이전]</a>&nbsp; <%
 	}
 %> <%
