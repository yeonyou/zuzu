			...
			<td colspan=2 align=center>
				...
				<form action="./AdminOrderModify.ao" name="orderform" method="post">
					...
					<table width=80% border="0" cellpadding="0" cellspacing="1">
						...
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt; font-weight: bold;" width=130 height=24 bgcolor="f7f7f7" colspan=2>상품 정보</td>
						</tr>
						<tr>
							<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
						</tr>
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt;" width=130 height=24 bgcolor="f7f7f7">상품이름</td>
						...
						<tr height=23>
							<td style="font-family: Tahoma; font-size: 8pt;" width=130 height=24 bgcolor="f7f7f7">수량</td>
						...
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt;" width=130 height=24 bgcolor="f7f7f7">사이즈</td>
						...
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt; font-weight: bold;" width=130 height=24 bgcolor="f7f7f7" colspan=2>배송지 정보</td>
						</tr>
						<tr>
							<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
						</tr>
						...
						<tr height=23>
							<td style="font-family: Tahoma; font-size: 8pt;" width=130 height=24 bgcolor="f7f7f7">집전화</td>
						...
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt; font-weight: bold;" width=130 height=24 bgcolor="f7f7f7" colspan=2>주문자 정보</td>
						</tr>
						<tr>
							<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
						</tr>
						<tr height=20>
							<td style="font-family: Tahoma; font-size: 8pt;" width=130 height=24 bgcolor="f7f7f7">이메일주소</td>
					...
					<table width=80% border=0 cellpadding="0" cellspacing="1">
						...
						<tr>
							<td style="font-family: Tahoma; font-size: 8pt;" width=200 height=24 bgcolor="f7f7f7">주문 합계금액 :</td>
							<td width=320 height=24><font size=2><%=order.getORDER_SUM_MONEY()%>원</font></td>
						</tr>
						<tr>
							<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
						</tr>
						<tr>
							<td style="font-family: Tahoma; font-size: 8pt;" width=200 height=24 bgcolor="f7f7f7">결제방법 :</td>
						...
						<tr>
							<td style="font-family: Tahoma; font-size: 8pt;" width=200 height=24 bgcolor="f7f7f7">입금자명 :</td>
							<td width=320 height=24><font size=2><%=order.getORDER_TRADE_PAYER()%></font></td>
						</tr>
						<tr>
							<td style="font-family: Tahoma; font-size: 8pt;" width=200 height=24 bgcolor="f7f7f7">주문 상태 :</td>
							<td width=320 height=24><select name="status">
									<option value="0" <%if (order.getORDER_STATUS() == 0) {%> selected <%}%>>대기중</option>
									<option value="1" <%if (order.getORDER_STATUS() == 1) {%> selected <%}%>>발송 준비</option>
									<option value="2" <%if (order.getORDER_STATUS() == 2) {%> selected <%}%>>발송 완료</option>
									<option value="3" <%if (order.getORDER_STATUS() == 3) {%> selected <%}%>>배송중</option>
									<option value="4" <%if (order.getORDER_STATUS() == 4) {%> selected <%}%>>배송 완료</option>
									<option value="5" <%if(order.getORDER_STATUS()==5){%> selected <%}%>>주문 취소</option>
							</select></td>
						</tr>
						...
						<tr>
							<td align=center style="background-color: #F0F0F0; height: 1px;" colspan=6><input type=submit value="수정">&nbsp; <input type=button onclick="javascript:location.href('./AdminOrderList.ao')" value="취소"></td>
						</tr>
